...
import cn.idesign.cui.swipe.SwipeableDefaults.StandardResistanceFactor
import cn.idesign.cui.swipe.SwipeableDefaults.VelocityThreshold
import cn.idesign.cui.swipe.SwipeableDefaults.resistanceConfig
...
open class SwipeableState<T>(
    initialValue: T,
    internal val animationSpec: AnimationSpec<Float> = TweenSpec(),
